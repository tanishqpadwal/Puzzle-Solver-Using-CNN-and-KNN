...
class HomePage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.titlelabel = Label(self, text="Puzzle Solver implementing CNN & KNN", relief=GROOVE, font=("Consolas 18"), bg="grey")
        self.titlelabel.grid(row=0, columnspan=4, sticky="ew")

        self.selimg = Button(self, text='Select Puzzle', command=self.open_img, relief=RAISED, fg="blue", bg="light blue",
        ...
        self.imglabel = Label(self, text="", font=("Consolas 10"))
        ...
        self.mylink = Label(self, text="18BCE2237 & 18BCE2185", borderwidth=3, relief=SUNKEN, fg="blue",
                            cursor="hand2")
...
class StagesFrame(Frame):
    ...
    def homefunc(self):
        ...
        self.controller.title("Puzzle Solver")
